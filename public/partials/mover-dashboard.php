...
<span class="gd-sidebar-nav__icon">🏠</span> <?php esc_html_e( 'Dashboard', 'go-deliver' ); ?>
</a>
<a class="gd-sidebar-nav__item" data-panel="browse-jobs" role="button" tabindex="0">
<span class="gd-sidebar-nav__icon">🔍</span> <?php esc_html_e( 'Browse Jobs', 'go-deliver' ); ?>
</a>
<a class="gd-sidebar-nav__item" data-panel="my-jobs" role="button" tabindex="0">
<span class="gd-sidebar-nav__icon">📋</span> <?php esc_html_e( 'My Jobs', 'go-deliver' ); ?>
...
<span class="gd-sidebar-nav__icon">💬</span> <?php esc_html_e( 'Messages', 'go-deliver' ); ?>
</a>
<a class="gd-sidebar-nav__item" data-panel="reviews" role="button" tabindex="0">
<span class="gd-sidebar-nav__icon">⭐</span> <?php esc_html_e( 'Reviews', 'go-deliver' ); ?>
<?php if ( $review_count ) : ?>
...
<span class="gd-sidebar-nav__icon">⚙️</span> <?php esc_html_e( 'Settings', 'go-deliver' ); ?>
</a>
<?php if ( $is_mover ) : ?>
<a class="gd-sidebar-nav__item" data-panel="team" role="button" tabindex="0">
<span class="gd-sidebar-nav__icon">👥</span> <?php esc_html_e( 'Team Members', 'go-deliver' ); ?>
</a>
<?php endif; ?>
</nav>
